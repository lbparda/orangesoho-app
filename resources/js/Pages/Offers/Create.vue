...
const saveOffer = () => {
    ...
    try {
        ...
        form.lines = lines.value.map(line => ({
            ...
            terminal_pivot_id: line.terminal_pivot?.id || null, initial_cost: line.initial_cost, monthly_cost: line.monthly_cost,
        }));
                    ...
                    <div class="p-8 bg-white border-b border-gray-200">
                        ...
                        <div v-if="selectedPackage" class="space-y-10">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                                ...
                                <div class="md:col-span-1 space-y-6 sticky top-10 self-start"> {/* Sticky para que se quede fijo */}
                            ...
                            </div> <div class="space-y-6 mt-10"> {/* Añadido mt-10 para separar */}
                                <h3 class="text-lg font-semibold text-gray-800 text-center">7. Líneas Móviles</h3>
                                <div v-if="lines.length === 0" class="text-gray-500 text-sm text-center"> {/* Centrado el mensaje */}
