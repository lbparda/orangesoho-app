                                    ...
                                    <div class="ms-3 relative">
                                        <Dropdown align="right" width="48">
                                            ...
                                            <template #content>
                                                ...
                                                <DropdownLink :href="route('terminals.import.create')"> Importar Terminales Soho </DropdownLink>
                                                
                                                <!-- ENLACE NUEVO: Importar Terminales PYME -->
                                                <DropdownLink :href="route('pyme.terminals.import.create')"> Importar Terminales PYME </DropdownLink>
                ...
                <div :class="{ block: showingNavigationDropdown, hidden: !showingNavigationDropdown }" class="sm:hidden">
                    ...
                    <div v-if="isAdmin" class="border-t border-gray-200 pt-4 pb-1">
                        ...
                        <div class="mt-3 space-y-1">
                            ...
                            <ResponsiveNavLink :href="route('terminals.import.create')"> Importar Terminales Soho</ResponsiveNavLink>
                            
                            <!-- ENLACE NUEVO RESPONSIVE -->
                            <ResponsiveNavLink :href="route('pyme.terminals.import.create')"> Importar Terminales PYME</ResponsiveNavLink>
